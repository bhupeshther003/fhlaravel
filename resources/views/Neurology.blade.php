...
@endif
		...
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12 ">
					<img src="https://th.bing.com/th/id/OIP.92576xmmEo38Lvte2nZRFAHaGp?pid=ImgDet&rs=1" alt="Neurology">
				</div>
				<div class="col-md-6 col-sm-12 ">
					<h4>	
                        Neurology</h4>
					<p>Neurology (from Greek: νεῦρον (neûron), "string, nerve" and the suffix -logia, "study of") is the branch of medicine dealing with the diagnosis and treatment of all categories of conditions and disease
                         involving the brain, the spinal cord and the peripheral nerves. 
	...
	<div class="row">
		<p class=" m-atuo">Furture Health » Specialities » Neurology</p>
	</div>

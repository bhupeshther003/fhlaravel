...
@endif
		...
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12 ">
					<img src="https://www.narayanahealth.org/sites/default/files/adult-kidney-transplant.png" alt="Haematology">
				</div>
				<div class="col-md-6 col-sm-12 ">
					<h4>	
                        Adult Kidney Transplant</h4>
					<p>The Kidney Transplant team at Narayana Health is among the most experienced and skilled in India. Our Transplant Specialists work together to perform Complex Transplant cases.
	...
	<div class="row">
		<p class=" m-atuo">Furture Health » Specialities » Haematology</p>
	</div>

...
@endif
		...
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<img src="https://www.starlingphysicians.com/wp-content/uploads/2018/11/Physiatry.jpg" alt="Physical Medicine">
				</div>
				<div class="col-md-6 col-sm-12">
					<h4>physical Mediacine & Rehabilition</h4>
					<p>Physical Medicine and Rehabilitation articles covering symptoms, causes, diagnosis, treatment, rehabilitation, prognosis, and follow-up.
	...
	<div class="row">
		<p class=" m-atuo">Furture Health » Specialities » Orthopadics</p>
	</div>
	...
	<div class="row">
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			...
			<p>
                Apollo Institutes of Orthopedics Expertise. The Apollo Institutes of Orthopedics is regarded as one of the best & top
                 orthopedics hospitals in India with a legacy of </p>

			<p>PM&Rphysicians and care teams place the concept of restoring function at the center of the therapies we offer, and it's a key strength of our program.
             Restoring function simply means helping you regain the best options for your quality of life, retain as much muscle ability as possible, </p>
...
<ul>
			...
			<h4>What Is an Orthopedic Doctor</h4>

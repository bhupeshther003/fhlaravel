...
<body>
    ...
    <div class="row position-relative">
        <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
            ...
            <div class="row ">
                <div class="col-md-6 col-sm-12 ">
                    <img src="https://th.bing.com/th/id/R.116bd7d1ab777cf4642e1273638eb28c?rik=dAiqaK6Mr2Jc%2fw&riu=http%3a%2f%2fwww.medimaxcare.in%2fwp-content%2fuploads%2f2018%2f11%2fnephrology.jpg&ehk=4dleTLWZTngnX9j%2bjpCQobeC1gSd09nIly9MSixeFS4%3d&risl=&pid=ImgRaw&r=0"
                        alt="Nephrology">
                </div>
                <div class="col-md-6 col-sm-12">
                    <h4>
                        Nephrology</h4>
                    <p>Nephrology future Health is among the most experienced and skilled in India. Our Transplant
                        Specialists work together to perform Complex Transplant cases.
        ...
        <div class="col-xl-4 col-lg-4 col-sm-12 ms-1">
            ...
            <div class="col">
                <select name="hos" id="hos-clinic"  class="select1" placeholder="Hospitals and Clinic" value={{ old('hos') }}>
    ...
    <div class="row">
        <p class=" m-atuo">Furture Health » Specialities » Nephrology</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            ...
            <p>Hematology, or Haematology, is the medicinal branch that deals with blood related diseases. The cause of
            ...
            <h4>What Is Nephrology and What Does a Nephrologist Do?</h4>
            ...
            <ul>
                ...
                <li>Histopathology to look at tissue biopsies at the microscopic level</li>
            </ul>

            <p></p>
            <h6>Treatments</h6>

            <p>The treatment will be guided by the doctors at our hospital for blood cancer treatment in India and it
                will be guided by our doctors and it will depend on the type of blood cancer, health condition of the
                patient at the time of the treatment, and how they wish to receive the treatments. Some need a single
                type of treatment and some may need several. Strong treatments are not for everyone, these tend to be
                taxing on the body and are not recommended unless absolutely necessary. Gentler treatment options appeal
                to many as it supports a good quality of life, even if it fails to cure blood cancer.</p>

            <p>Everyone is different, so the treatment is classified in several sections that suits individual needs.
            </p>

            <p>
            <h6 style="display: inline-block;">Intensive treatment: </h6> Intensive treatments are strong treatments
            and require the use of strong drugs to stop the spread of cancer cells. Primary examples of intensive
            treatment are as follows:</p>
            <ul>

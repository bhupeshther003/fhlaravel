...
@endif
		...
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<img src="https://healthjade.com/wp-content/uploads/2017/08/heart-attack.jpg" alt="heart attack">
				</div>
				<div class="col-md-6 col-sm-12 ">
					<h4>	
                       Heart Attack</h4>
					<p>A brain tumor is a growth of cells in the brain or near it. Brain tumors can happen in the brain tissue. Brain tumors also can happen near the brain tissue. Nearby locations include nerves, the pituitary gland, the pineal gland, 
						and the membranes that cover the surface of the brain. Brain tumors can begin in the brain.</p>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<p class=" m-atuo">Furture Health » Specialities » Hrard Attack</p>
	</div>
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			...
			<p>
				A heart attack occurs when the flow of blood to the heart is severely reduced or blocked. The blockage is usually due to a buildup of fat, cholesterol and other substances in the heart (coronary) arteries.
                 The fatty, cholesterol-containing deposits are called plaques. T</p>

			<p> Heart Attack Symptoms. Discomfort, pressure, heaviness, tightness, squeezing, or pain in your chest or arm or below your breastbone. </p>

...
@endif
		...
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<img src="https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2020/04/GettyImages-951890054_thumb.jpg" alt="Orthopadics">
				</div>
				<div class="col-md-6 col-sm-12">
					<h4>	
                        Orthopadics</h4>
					<p>Orthopedic medicine treats the musculoskeletal system. Healthcare providers in this field of medicine specialize in the diagnosis, treatment, and therapy of conditions …
	...
	<div class="row">
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			...
			<p>Orthopedic surgery or orthopedics (alternatively spelt orthopaedics), is the branch of surgery concerned with conditions involving the musculoskeletal system. Orthopedic surgeons use both surgical and nonsurgical means to treat musculoskeletal trauma, 
                spine diseases, sports injuries, degenerative diseases, infections, tumors, and congenital disorders.</p>

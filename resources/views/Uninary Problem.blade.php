...
@endif
	...
	<div class="row position-relative">
		<div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
			...
			<div class="row m-5">
				<div class="col-md-6 col-sm-12">
					<img src="https://assets.lybrate.com/eagle/uploads/cca97c80d89ae5468547088748abbee7/eae4eb.jpg" alt="Uninary Problem">
				</div>
				<div class="col-md-6 col-sm-12 ">
					<h4>	
                        Uninary Problem</h4>
					<p>A urinary tract infection (UTI) is an infection in any part of the urinary system. The urinary system includes the kidneys, ureters, bladder and urethra. 
                        Most infections involve the lower urinary tract — the bladder and the urethra. Women are at greater risk of developing a UTI than are men. </p>
				</div>
			</div>
		</div>
		<div class="col-xl-4 col-lg-4 col-sm-12 ms-1">
			...
			<div class="col">
				<select name="loc" id="location" class="select1" placeholder="Location"  value={{old('loc')}}>
	...
	<div class="row">
		<p class=" m-atuo">Furture Health » Specialities » Uninary Problem</p>
	</div>
	...
	<div class="row">
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			...
			<h4>Uninary Problem</h4>
			
			

			<p>
				Blurred vision Bumps, blisters or open sores around genitals Change in vaginal discharge Clear discharge from penis Extreme thirst or hunger Fatigue</p>

			<p> Ingestion of diuretics like excess caffeine, alcohol, carbonated drinks, etc.
                UTIs can also result in incontinence
                Constipation to such a degree that the unpassed stools cause the nerves of your bladder to </p>


			<p>commonly known as a heart attack, occurs when blood flow decreases or stops to the coronary artery of the heart, causing damage to the heart :</p>
<ul>

...
@section('content')
    ...
    <body>
            ...
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 p-5  ">
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12">
                        <img src="https://img.freepik.com/premium-photo/modern-mri-machine-room_99433-3957.jpg?size=626&ext=jpg&ga=GA1.1.1406591241.1684115342&semt=ais"
                            alt="Orthopadics">
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <h4>Ortho-Oncology</h4>
                        <p>Orthopaedic oncology is a branch of medical science and orthopaedic surgery that deals with
        ...
        <div class="row">
            <p class=" m-atuo">Furture Health » Specialities »Ortho-Oncology</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12">
                ...
                <p>
                    ...
                    Explain what orthopaedic oncology is and its importance in the field of orthopedics.
                    Discuss the types of tumors that orthopaedic oncologists deal with, such as primary bone tumors,
                    metastatic bone tumors, and soft tissue sarcomas.
                </p>

                <p>
                    <strong>Conditions and Diagnoses:</strong>

                    Provide information about different types of bone and soft tissue tumors, including osteosarcoma, Ewing
                    sarcoma, chondrosarcoma, and malignant fibrous histiocytoma.
                    Explain how these tumors are diagnosed, including imaging techniques like X-rays, MRI, CT scans, and
                    biopsy procedures.
                ...
                <h4>What Is an Ortho-Oncology Doctor</h4>
                ...
                <p>
                    <strong>Research and Advances:</strong>

                    Discuss recent advancements and ongoing research in orthopaedic oncology, such as targeted therapies,
                    immunotherapies, and minimally invasive surgical techniques.
                    Highlight any breakthroughs or promising developments in the field. these tend to be taxing on the body
                    and are not recommended unless absolutely necessary. Gentler treatment options appeal to many as it
                    supports a good quality of life, even if it fails to cure blood cancer.
                </p>

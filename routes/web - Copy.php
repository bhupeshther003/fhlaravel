...
use App\Http\Controllers\authontication_controller;
...
// Route::get('/environment',[basic_controller::class,'environment']);    
...
// Route::get('/carrier_login', function(){
// if(session()->has ('user ' ))
// return redirect()->back();
// return view('carrier_login'); });
